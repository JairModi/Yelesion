...
function SiteNav({ portfolio = false }) {
  return (
    <nav className="nav" aria-label="Main navigation">
      ...
      <div className="nav-links">{portfolio ? <a href="/">Back home</a> : <><a href="#meaning">Our meaning</a><a href="#services">Services</a><a href="#contact">Contact</a><a href="/portfolio">Portfolio</a></>}</div>
    </nav>
  )
}
